...
#define AXIS_Y A1
#define AXIS_Z A0
#define AXIS_HISTORICAL_COUNT 300
...
// LED Variables
const bool is_external_led[STRIP_SIZE] = {true, false, false, true, true, false, false, true, true, false, false, true, false, true, false, true, false, true, false, true, false, true, false, true, true, false, false, true, false, true, false, true, true, false, false, true, false, true, false, true, true, false, false, true, true, true, false};
int8_t twinkles[MAX_TWINKLES] = {-1};
...
void loop(){
	updateAxis();
	updateIsTouched();
	if((sequence_no % AXIS_HISTORICAL_COUNT) == 0) {
	...
	if(
			(total_activity_metric >= HIGH_ACTIVITY_THRESHOLD && !is_touched[1])
		||	(total_activity_metric < HIGH_ACTIVITY_THRESHOLD && is_touched[1])){
		setAllPixels(colourFromAxis());
		twinkleExternal(15);
		if(is_touched[0])
			setExternalColour(PINK);
		...
		if(is_touched[0]){
			...
			setExternalColour(BLACK);
		}


		twinkleExternal(WHITE, 45-(total_activity_metric*8));
